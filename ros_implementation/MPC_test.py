...
from set_pose.srv import set_pose
...
def reset_client(x,y,z,roll,pitch,yaw):
    ...
    add_two_ints = rospy.ServiceProxy('/zed2i/zed_node/set_pose', set_pose)
    add_two_ints(x,y,z,roll,pitch,yaw)
def control_node():
...
pub = rospy.Publisher('/mavros/setpoint_velocity/cmd_vel_unstamped', Twist, queue_size=20)
...
if __name__ == '__main__':
    ...
    try:
        ...
        print("Shuuting down the controller")
